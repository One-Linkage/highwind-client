...
class AFSResponseResults(BaseModel):
    """
    AFSResponseResults
    """ # noqa: E501
    is_afs: Optional[StrictBool] = None
    pages_processed: Optional[StrictInt] = None
    details: Optional[AFSResponseResultsDetails] = None
    summary: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["is_afs", "pages_processed", "details", "summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "is_afs": obj.get("is_afs"),
            "pages_processed": obj.get("pages_processed"),
            "details": AFSResponseResultsDetails.from_dict(obj["details"]) if obj.get("details") is not None else None,

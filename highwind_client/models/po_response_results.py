...
class POResponseResults(BaseModel):
    """
    POResponseResults
    """ # noqa: E501
    is_purchase_order: Optional[StrictBool] = None
    pages_processed: Optional[StrictInt] = None
    details: Optional[POResponseResultsDetails] = None
    summary: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["is_purchase_order", "pages_processed", "details", "summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "is_purchase_order": obj.get("is_purchase_order"),
            "pages_processed": obj.get("pages_processed"),
            "details": POResponseResultsDetails.from_dict(obj["details"]) if obj.get("details") is not None else None,

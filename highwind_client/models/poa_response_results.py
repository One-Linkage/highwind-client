...
class POAResponseResults(BaseModel):
    """
    POAResponseResults
    """ # noqa: E501
    is_proof_of_address: Optional[StrictBool] = None
    pages_processed: Optional[StrictInt] = None
    details: Optional[POAResponseResultsDetails] = None
    summary: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["is_proof_of_address", "pages_processed", "details", "summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "is_proof_of_address": obj.get("is_proof_of_address"),
            "pages_processed": obj.get("pages_processed"),
            "details": POAResponseResultsDetails.from_dict(obj["details"]) if obj.get("details") is not None else None,

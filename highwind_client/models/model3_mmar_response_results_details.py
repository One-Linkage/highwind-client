...
class Model3MMARResponseResultsDetails(BaseModel):
    """
    ...
    balance_sheet: Optional[AFSResponseResultsDetailsStatementOfFinancialPosition] = None
    cash_flow_statement: Optional[AFSResponseResultsDetailsStatementOfFinancialPosition] = None
    statement_date_period: Optional[Model3MBSResponseResultsDetailsStatementDatePeriod] = None
    report_date: Optional[Model3MMARResponseResultsDetailsReportDate] = None
    document_recent: Optional[AFSResponseResultsDetailsDocumentRecent] = None
    statement_covers_3_months: Optional[AFSResponseResultsDetailsStatementOfFinancialPosition] = None
    __properties: ClassVar[List[str]] = ["statement_of_profit_and_loss", "balance_sheet", "cash_flow_statement", "statement_date_period", "report_date", "document_recent", "statement_covers_3_months"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.cash_flow_statement:
            _dict['cash_flow_statement'] = self.cash_flow_statement.to_dict()
        ...
        if self.report_date:
            _dict['report_date'] = self.report_date.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "balance_sheet": AFSResponseResultsDetailsStatementOfFinancialPosition.from_dict(obj["balance_sheet"]) if obj.get("balance_sheet") is not None else None,
            "cash_flow_statement": AFSResponseResultsDetailsStatementOfFinancialPosition.from_dict(obj["cash_flow_statement"]) if obj.get("cash_flow_statement") is not None else None,
            ...
            "report_date": Model3MMARResponseResultsDetailsReportDate.from_dict(obj["report_date"]) if obj.get("report_date") is not None else None,
            ...
            "statement_covers_3_months": AFSResponseResultsDetailsStatementOfFinancialPosition.from_dict(obj["statement_covers_3_months"]) if obj.get("statement_covers_3_months") is not None else None
        })
        return _obj

...
class BCLResponseResults(BaseModel):
    """
    BCLResponseResults
    """ # noqa: E501
    is_bank_confirmation_letter: Optional[StrictBool] = None
    pages_processed: Optional[StrictInt] = None
    details: Optional[BCLResponseResultsDetails] = None
    summary: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["is_bank_confirmation_letter", "pages_processed", "details", "summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "is_bank_confirmation_letter": obj.get("is_bank_confirmation_letter"),
            "pages_processed": obj.get("pages_processed"),
            "details": BCLResponseResultsDetails.from_dict(obj["details"]) if obj.get("details") is not None else None,

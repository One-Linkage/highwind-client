...
class BEECResponseResults(BaseModel):
    """
    BEECResponseResults
    """ # noqa: E501
    is_bee_certificate: Optional[StrictBool] = None
    pages_processed: Optional[StrictInt] = None
    details: Optional[BEECResponseResultsDetails] = None
    summary: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["is_bee_certificate", "pages_processed", "details", "summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "is_bee_certificate": obj.get("is_bee_certificate"),
            "pages_processed": obj.get("pages_processed"),
            "details": BEECResponseResultsDetails.from_dict(obj["details"]) if obj.get("details") is not None else None,

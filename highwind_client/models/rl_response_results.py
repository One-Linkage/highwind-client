...
class RLResponseResults(BaseModel):
    """
    RLResponseResults
    """ # noqa: E501
    is_reference_letter: Optional[StrictBool] = None
    pages_processed: Optional[StrictInt] = None
    details: Optional[RLResponseResultsDetails] = None
    summary: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["is_reference_letter", "pages_processed", "details", "summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "is_reference_letter": obj.get("is_reference_letter"),
            "pages_processed": obj.get("pages_processed"),
            "details": RLResponseResultsDetails.from_dict(obj["details"]) if obj.get("details") is not None else None,

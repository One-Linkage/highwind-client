...
class LGSResponse(BaseModel):
    """
    LGSResponse
    """ # noqa: E501
    status: Optional[StrictStr] = None
    results: Optional[LGSResponseResults] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": LGSResponseResults.from_dict(obj["results"]) if obj.get("results") is not None else None
        })
        return _obj

...
class BEEAResponseResults(BaseModel):
    """
    BEEAResponseResults
    """ # noqa: E501
    is_bee_affidavit: Optional[StrictBool] = None
    pages_processed: Optional[StrictInt] = None
    details: Optional[BEEAResponseResultsDetails] = None
    summary: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["is_bee_affidavit", "pages_processed", "details", "summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "is_bee_affidavit": obj.get("is_bee_affidavit"),
            "pages_processed": obj.get("pages_processed"),
            "details": BEEAResponseResultsDetails.from_dict(obj["details"]) if obj.get("details") is not None else None,

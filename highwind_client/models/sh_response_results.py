...
class SHResponseResults(BaseModel):
    """
    SHResponseResults
    """ # noqa: E501
    is_shareholders_certificate: Optional[StrictBool] = None
    pages_processed: Optional[StrictInt] = None
    details: Optional[SHResponseResultsDetails] = None
    summary: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["is_shareholders_certificate", "pages_processed", "details", "summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "is_shareholders_certificate": obj.get("is_shareholders_certificate"),
            "pages_processed": obj.get("pages_processed"),
            "details": SHResponseResultsDetails.from_dict(obj["details"]) if obj.get("details") is not None else None,

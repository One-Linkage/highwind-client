...
class COPResponseResults(BaseModel):
    """
    COPResponseResults
    """ # noqa: E501
    is_company_profile: Optional[StrictBool] = None
    pages_processed: Optional[StrictInt] = None
    details: Optional[COPResponseResultsDetails] = None
    summary: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["is_company_profile", "pages_processed", "details", "summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "is_company_profile": obj.get("is_company_profile"),
            "pages_processed": obj.get("pages_processed"),
            "details": COPResponseResultsDetails.from_dict(obj["details"]) if obj.get("details") is not None else None,

...
class Model3MMARResponseResults(BaseModel):
    """
    Model3MMARResponseResults
    """ # noqa: E501
    is_3_month_management_account_report: Optional[StrictBool] = None
    pages_processed: Optional[StrictInt] = None
    details: Optional[Model3MMARResponseResultsDetails] = None
    summary: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["is_3_month_management_account_report", "pages_processed", "details", "summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "is_3_month_management_account_report": obj.get("is_3_month_management_account_report"),
            "pages_processed": obj.get("pages_processed"),
            "details": Model3MMARResponseResultsDetails.from_dict(obj["details"]) if obj.get("details") is not None else None,

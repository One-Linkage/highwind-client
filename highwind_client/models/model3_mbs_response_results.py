...
class Model3MBSResponseResults(BaseModel):
    """
    Model3MBSResponseResults
    """ # noqa: E501
    is_3_month_bank_statement: Optional[StrictBool] = None
    pages_processed: Optional[StrictInt] = None
    details: Optional[Model3MBSResponseResultsDetails] = None
    summary: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["is_3_month_bank_statement", "pages_processed", "details", "summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "is_3_month_bank_statement": obj.get("is_3_month_bank_statement"),
            "pages_processed": obj.get("pages_processed"),
            "details": Model3MBSResponseResultsDetails.from_dict(obj["details"]) if obj.get("details") is not None else None,

...
class CIPCResponseResults(BaseModel):
    """
    CIPCResponseResults
    """ # noqa: E501
    is_cipc: Optional[StrictBool] = None
    pages_processed: Optional[StrictInt] = None
    details: Optional[CIPCResponseResultsDetails] = None
    summary: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["is_cipc", "pages_processed", "details", "summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "is_cipc": obj.get("is_cipc"),
            "pages_processed": obj.get("pages_processed"),
            "details": CIPCResponseResultsDetails.from_dict(obj["details"]) if obj.get("details") is not None else None,

...
class CONResponseResults(BaseModel):
    """
    CONResponseResults
    """ # noqa: E501
    is_contract: Optional[StrictBool] = None
    pages_processed: Optional[StrictInt] = None
    details: Optional[CONResponseResultsDetails] = None
    summary: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["is_contract", "pages_processed", "details", "summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "details": CONResponseResultsDetails.from_dict(obj["details"]) if obj.get("details") is not None else None,

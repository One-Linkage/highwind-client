...
class Model3MMARResponse(BaseModel):
    """
    Model3MMARResponse
    """ # noqa: E501
    status: Optional[StrictStr] = None
    results: Optional[Model3MMARResponseResults] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": Model3MMARResponseResults.from_dict(obj["results"]) if obj.get("results") is not None else None
        })
        return _obj

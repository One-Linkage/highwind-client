...
class IDResponseResults(BaseModel):
    """
    IDResponseResults
    """ # noqa: E501
    is_certified_id: Optional[StrictBool] = None
    pages_processed: Optional[StrictInt] = None
    details: Optional[IDResponseResultsDetails] = None
    summary: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["is_certified_id", "pages_processed", "details", "summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "is_certified_id": obj.get("is_certified_id"),
            "pages_processed": obj.get("pages_processed"),
            "details": IDResponseResultsDetails.from_dict(obj["details"]) if obj.get("details") is not None else None,

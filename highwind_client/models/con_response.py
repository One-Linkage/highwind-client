...
class CONResponse(BaseModel):
    """
    CONResponse
    """ # noqa: E501
    status: Optional[StrictStr] = None
    results: Optional[CONResponseResults] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": CONResponseResults.from_dict(obj["results"]) if obj.get("results") is not None else None
        })
        return _obj

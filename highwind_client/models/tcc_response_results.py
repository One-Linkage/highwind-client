...
class TCCResponseResults(BaseModel):
    """
    TCCResponseResults
    """ # noqa: E501
    is_tax_clearance_certificate: Optional[StrictBool] = None
    pages_processed: Optional[StrictInt] = None
    details: Optional[TCCResponseResultsDetails] = None
    summary: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["is_tax_clearance_certificate", "pages_processed", "details", "summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "is_tax_clearance_certificate": obj.get("is_tax_clearance_certificate"),
            "pages_processed": obj.get("pages_processed"),
            "details": TCCResponseResultsDetails.from_dict(obj["details"]) if obj.get("details") is not None else None,

...
class BEECResponseResultsDetails(BaseModel):
    """
    BEECResponseResultsDetails
    """ # noqa: E501
    enterprise_name: Optional[POResponseResultsDetailsVendorName] = None
    enterprise_registration_number: Optional[BEECResponseResultsDetailsEnterpriseRegistrationNumber] = None
    certificate_number: Optional[BEECResponseResultsDetailsEnterpriseRegistrationNumber] = None
    certificate_issuer_name: Optional[BEECResponseResultsDetailsEnterpriseRegistrationNumber] = None
    ...
    total_number_of_shareholders: Optional[BEECResponseResultsDetailsTotalNumberOfShareholders] = None
    number_of_black_shareholders: Optional[BEECResponseResultsDetailsTotalNumberOfShareholders] = None
    number_of_white_shareholders: Optional[BEECResponseResultsDetailsTotalNumberOfShareholders] = None
    ...
    white_ownership_percentage: Optional[BEEAResponseResultsDetailsBlackOwnershipPercentage] = None
    ...
    __properties: ClassVar[List[str]] = ["enterprise_name", "enterprise_registration_number", "certificate_number", "certificate_issuer_name", "certificate_issue_date", "certificate_expiry_date", "document_recent", "total_number_of_shareholders", "number_of_black_shareholders", "number_of_white_shareholders", "black_ownership_percentage", "black_ownership_female_percentage", "white_ownership_percentage", "black_designated_group_owned_percentage_breakdown_youth", "black_designated_group_owned_percentage_breakdown_disabled", "black_designated_group_owned_percentage_breakdown_unemployed", "black_designated_group_owned_percentage_breakdown_rural", "black_designated_group_owned_percentage_breakdown_veterans"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of certificate_issuer_name
        if self.certificate_issuer_name:
            _dict['certificate_issuer_name'] = self.certificate_issuer_name.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of total_number_of_shareholders
        if self.total_number_of_shareholders:
            _dict['total_number_of_shareholders'] = self.total_number_of_shareholders.to_dict()
        # override the default output from pydantic by calling `to_dict()` of number_of_black_shareholders
        if self.number_of_black_shareholders:
            _dict['number_of_black_shareholders'] = self.number_of_black_shareholders.to_dict()
        # override the default output from pydantic by calling `to_dict()` of number_of_white_shareholders
        if self.number_of_white_shareholders:
            _dict['number_of_white_shareholders'] = self.number_of_white_shareholders.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of white_ownership_percentage
        if self.white_ownership_percentage:
            _dict['white_ownership_percentage'] = self.white_ownership_percentage.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "enterprise_registration_number": BEECResponseResultsDetailsEnterpriseRegistrationNumber.from_dict(obj["enterprise_registration_number"]) if obj.get("enterprise_registration_number") is not None else None,
            ...
            "certificate_issuer_name": BEECResponseResultsDetailsEnterpriseRegistrationNumber.from_dict(obj["certificate_issuer_name"]) if obj.get("certificate_issuer_name") is not None else None,
            ...
            "total_number_of_shareholders": BEECResponseResultsDetailsTotalNumberOfShareholders.from_dict(obj["total_number_of_shareholders"]) if obj.get("total_number_of_shareholders") is not None else None,
            "number_of_black_shareholders": BEECResponseResultsDetailsTotalNumberOfShareholders.from_dict(obj["number_of_black_shareholders"]) if obj.get("number_of_black_shareholders") is not None else None,
            "number_of_white_shareholders": BEECResponseResultsDetailsTotalNumberOfShareholders.from_dict(obj["number_of_white_shareholders"]) if obj.get("number_of_white_shareholders") is not None else None,
            ...
            "white_ownership_percentage": BEEAResponseResultsDetailsBlackOwnershipPercentage.from_dict(obj["white_ownership_percentage"]) if obj.get("white_ownership_percentage") is not None else None,

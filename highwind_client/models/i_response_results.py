...
class IResponseResults(BaseModel):
    """
    IResponseResults
    """ # noqa: E501
    is_invoice: Optional[StrictBool] = None
    pages_processed: Optional[StrictInt] = None
    details: Optional[IResponseResultsDetails] = None
    summary: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["is_invoice", "pages_processed", "details", "summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "is_invoice": obj.get("is_invoice"),
            "pages_processed": obj.get("pages_processed"),
            "details": IResponseResultsDetails.from_dict(obj["details"]) if obj.get("details") is not None else None,

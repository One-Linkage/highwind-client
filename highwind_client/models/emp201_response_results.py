...
class EMP201ResponseResults(BaseModel):
    """
    EMP201ResponseResults
    """ # noqa: E501
    is_emp201: Optional[StrictBool] = None
    pages_processed: Optional[StrictInt] = None
    details: Optional[EMP201ResponseResultsDetails] = None
    summary: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["is_emp201", "pages_processed", "details", "summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "is_emp201": obj.get("is_emp201"),
            "pages_processed": obj.get("pages_processed"),
            "details": EMP201ResponseResultsDetails.from_dict(obj["details"]) if obj.get("details") is not None else None,

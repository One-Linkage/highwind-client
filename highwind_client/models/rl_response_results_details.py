...
class RLResponseResultsDetails(BaseModel):
    """
    RLResponseResultsDetails
    """ # noqa: E501
    vendor_company_name: Optional[POResponseResultsDetailsVendorName] = None
    client_company_name: Optional[RLResponseResultsDetailsClientCompanyName] = None
    ...
    services_product_description: Optional[BCLResponseResultsDetailsVerificationStatement] = None
    services_product_rendered_date: Optional[RLResponseResultsDetailsServicesProductRenderedDate] = None
    __properties: ClassVar[List[str]] = ["vendor_company_name", "client_company_name", "document_date", "document_recent", "services_product_description", "services_product_rendered_date"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of vendor_company_name
        if self.vendor_company_name:
            _dict['vendor_company_name'] = self.vendor_company_name.to_dict()
        # override the default output from pydantic by calling `to_dict()` of client_company_name
        if self.client_company_name:
            _dict['client_company_name'] = self.client_company_name.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of services_product_description
        if self.services_product_description:
            _dict['services_product_description'] = self.services_product_description.to_dict()
        # override the default output from pydantic by calling `to_dict()` of services_product_rendered_date
        if self.services_product_rendered_date:
            _dict['services_product_rendered_date'] = self.services_product_rendered_date.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "vendor_company_name": POResponseResultsDetailsVendorName.from_dict(obj["vendor_company_name"]) if obj.get("vendor_company_name") is not None else None,
            "client_company_name": RLResponseResultsDetailsClientCompanyName.from_dict(obj["client_company_name"]) if obj.get("client_company_name") is not None else None,
            ...
            "services_product_description": BCLResponseResultsDetailsVerificationStatement.from_dict(obj["services_product_description"]) if obj.get("services_product_description") is not None else None,
            "services_product_rendered_date": RLResponseResultsDetailsServicesProductRenderedDate.from_dict(obj["services_product_rendered_date"]) if obj.get("services_product_rendered_date") is not None else None
        })
        return _obj

...
class LGSResponseResults(BaseModel):
    """
    LGSResponseResults
    """ # noqa: E501
    is_certified_lgs: Optional[StrictBool] = None
    pages_processed: Optional[StrictInt] = None
    details: Optional[LGSResponseResultsDetails] = None
    summary: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["is_certified_lgs", "pages_processed", "details", "summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "is_certified_lgs": obj.get("is_certified_lgs"),
            "pages_processed": obj.get("pages_processed"),
            "details": LGSResponseResultsDetails.from_dict(obj["details"]) if obj.get("details") is not None else None,

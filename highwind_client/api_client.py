...
from highwind_client.api_response import ApiResponse, T as ApiResponseT
import highwind_client.models
from highwind_client import rest
from highwind_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(highwind_client.models, klass)

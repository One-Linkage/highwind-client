...
class TestPOResponseResultsDetailsTotalAmount(unittest.TestCase):
    """POResponseResultsDetailsTotalAmount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> POResponseResultsDetailsTotalAmount:
        """Test POResponseResultsDetailsTotalAmount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `POResponseResultsDetailsTotalAmount`
        """
        model = POResponseResultsDetailsTotalAmount()
        if include_optional:
            return POResponseResultsDetailsTotalAmount(
                exists = True,
                value = '$ 4000.00'
            )
        else:
    ...
    def testPOResponseResultsDetailsTotalAmount(self):
        """Test POResponseResultsDetailsTotalAmount"""

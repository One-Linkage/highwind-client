...
class TestIResponseResults(unittest.TestCase):
    """IResponseResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IResponseResults:
        """Test IResponseResults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IResponseResults`
        """
        model = IResponseResults()
        if include_optional:
            return IResponseResults(
                is_invoice = True,
                pages_processed = 10,
                details = highwind_client.models.i_response_results_details.IResponse_results_details(

...
class TestSHResponseResultsDetailsCompanyShareholderIdNumbers(unittest.TestCase):
    """SHResponseResultsDetailsCompanyShareholderIdNumbers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SHResponseResultsDetailsCompanyShareholderIdNumbers:
        """Test SHResponseResultsDetailsCompanyShareholderIdNumbers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SHResponseResultsDetailsCompanyShareholderIdNumbers`
        """
        model = SHResponseResultsDetailsCompanyShareholderIdNumbers()
        if include_optional:
            return SHResponseResultsDetailsCompanyShareholderIdNumbers(
                exists = True,
    ...
    def testSHResponseResultsDetailsCompanyShareholderIdNumbers(self):
        """Test SHResponseResultsDetailsCompanyShareholderIdNumbers"""

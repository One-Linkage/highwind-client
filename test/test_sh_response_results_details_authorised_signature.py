...
class TestSHResponseResultsDetailsAuthorisedSignature(unittest.TestCase):
    """SHResponseResultsDetailsAuthorisedSignature unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SHResponseResultsDetailsAuthorisedSignature:
        """Test SHResponseResultsDetailsAuthorisedSignature
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SHResponseResultsDetailsAuthorisedSignature`
        """
        model = SHResponseResultsDetailsAuthorisedSignature()
        if include_optional:
            return SHResponseResultsDetailsAuthorisedSignature(
                exists = False
            )
        else:
            return SHResponseResultsDetailsAuthorisedSignature(
    ...
    def testSHResponseResultsDetailsAuthorisedSignature(self):
        """Test SHResponseResultsDetailsAuthorisedSignature"""

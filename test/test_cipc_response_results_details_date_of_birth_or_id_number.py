...
class TestCIPCResponseResultsDetailsDateOfBirthOrIdNumber(unittest.TestCase):
    """CIPCResponseResultsDetailsDateOfBirthOrIdNumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CIPCResponseResultsDetailsDateOfBirthOrIdNumber:
        """Test CIPCResponseResultsDetailsDateOfBirthOrIdNumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CIPCResponseResultsDetailsDateOfBirthOrIdNumber`
        """
        model = CIPCResponseResultsDetailsDateOfBirthOrIdNumber()
        if include_optional:
            return CIPCResponseResultsDetailsDateOfBirthOrIdNumber(
                exists = True,
                value = '9006129999999'
            )
        else:
    ...
    def testCIPCResponseResultsDetailsDateOfBirthOrIdNumber(self):
        """Test CIPCResponseResultsDetailsDateOfBirthOrIdNumber"""

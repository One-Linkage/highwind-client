...
class TestIDResponseResultsDetails(unittest.TestCase):
    """IDResponseResultsDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IDResponseResultsDetails:
        """Test IDResponseResultsDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IDResponseResultsDetails`
        """
        model = IDResponseResultsDetails()
        if include_optional:
            return IDResponseResultsDetails(
    ...
    def testIDResponseResultsDetails(self):
        """Test IDResponseResultsDetails"""

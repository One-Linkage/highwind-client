...
class TestCIPCResponseResultsDetailsEnterpriseStatus(unittest.TestCase):
    """CIPCResponseResultsDetailsEnterpriseStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CIPCResponseResultsDetailsEnterpriseStatus:
        """Test CIPCResponseResultsDetailsEnterpriseStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CIPCResponseResultsDetailsEnterpriseStatus`
        """
        model = CIPCResponseResultsDetailsEnterpriseStatus()
        if include_optional:
            return CIPCResponseResultsDetailsEnterpriseStatus(
                exists = True,
                value = 'In Business'
            )
        else:
    ...
    def testCIPCResponseResultsDetailsEnterpriseStatus(self):
        """Test CIPCResponseResultsDetailsEnterpriseStatus"""

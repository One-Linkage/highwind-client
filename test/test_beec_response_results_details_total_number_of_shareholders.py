...
class TestBEECResponseResultsDetailsTotalNumberOfShareholders(unittest.TestCase):
    """BEECResponseResultsDetailsTotalNumberOfShareholders unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BEECResponseResultsDetailsTotalNumberOfShareholders:
        """Test BEECResponseResultsDetailsTotalNumberOfShareholders
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BEECResponseResultsDetailsTotalNumberOfShareholders`
        """
        model = BEECResponseResultsDetailsTotalNumberOfShareholders()
        if include_optional:
            return BEECResponseResultsDetailsTotalNumberOfShareholders(
                exists = True,
                value = '1'
            )
        else:
    ...
    def testBEECResponseResultsDetailsTotalNumberOfShareholders(self):
        """Test BEECResponseResultsDetailsTotalNumberOfShareholders"""

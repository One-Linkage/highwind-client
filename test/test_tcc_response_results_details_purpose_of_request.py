...
class TestTCCResponseResultsDetailsPurposeOfRequest(unittest.TestCase):
    """TCCResponseResultsDetailsPurposeOfRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TCCResponseResultsDetailsPurposeOfRequest:
        """Test TCCResponseResultsDetailsPurposeOfRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TCCResponseResultsDetailsPurposeOfRequest`
        """
        model = TCCResponseResultsDetailsPurposeOfRequest()
        if include_optional:
            return TCCResponseResultsDetailsPurposeOfRequest(
                exists = False,
                value = 'Good Standing'
            )
        else:
    ...
    def testTCCResponseResultsDetailsPurposeOfRequest(self):
        """Test TCCResponseResultsDetailsPurposeOfRequest"""

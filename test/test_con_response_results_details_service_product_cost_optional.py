...
class TestCONResponseResultsDetailsServiceProductCostOptional(unittest.TestCase):
    """CONResponseResultsDetailsServiceProductCostOptional unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CONResponseResultsDetailsServiceProductCostOptional:
        """Test CONResponseResultsDetailsServiceProductCostOptional
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CONResponseResultsDetailsServiceProductCostOptional`
        """
        model = CONResponseResultsDetailsServiceProductCostOptional()
        if include_optional:
            return CONResponseResultsDetailsServiceProductCostOptional(
                exists = False,
                value = 'R100,000.00'
            )
        else:
    ...
    def testCONResponseResultsDetailsServiceProductCostOptional(self):
        """Test CONResponseResultsDetailsServiceProductCostOptional"""

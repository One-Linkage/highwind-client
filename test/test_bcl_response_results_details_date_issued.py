...
class TestBCLResponseResultsDetailsDateIssued(unittest.TestCase):
    """BCLResponseResultsDetailsDateIssued unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BCLResponseResultsDetailsDateIssued:
        """Test BCLResponseResultsDetailsDateIssued
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BCLResponseResultsDetailsDateIssued`
        """
        model = BCLResponseResultsDetailsDateIssued()
        if include_optional:
            return BCLResponseResultsDetailsDateIssued(
                exists = True,
                value = '2024-01-01'
            )
        else:
    ...
    def testBCLResponseResultsDetailsDateIssued(self):
        """Test BCLResponseResultsDetailsDateIssued"""

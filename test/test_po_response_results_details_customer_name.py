...
class TestPOResponseResultsDetailsCustomerName(unittest.TestCase):
    """POResponseResultsDetailsCustomerName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> POResponseResultsDetailsCustomerName:
        """Test POResponseResultsDetailsCustomerName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `POResponseResultsDetailsCustomerName`
        """
        model = POResponseResultsDetailsCustomerName()
        if include_optional:
            return POResponseResultsDetailsCustomerName(
                exists = True,
                value = 'Happy Shops'
            )
        else:
    ...
    def testPOResponseResultsDetailsCustomerName(self):
        """Test POResponseResultsDetailsCustomerName"""

...
class TestBEEAResponseResultsDetailsFullName(unittest.TestCase):
    """BEEAResponseResultsDetailsFullName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BEEAResponseResultsDetailsFullName:
        """Test BEEAResponseResultsDetailsFullName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BEEAResponseResultsDetailsFullName`
        """
        model = BEEAResponseResultsDetailsFullName()
        if include_optional:
            return BEEAResponseResultsDetailsFullName(
                exists = True,
                value = 'Moira Brown'
            )
        else:
    ...
    def testBEEAResponseResultsDetailsFullName(self):
        """Test BEEAResponseResultsDetailsFullName"""

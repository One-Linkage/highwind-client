...
class TestPOResponseResults(unittest.TestCase):
    """POResponseResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> POResponseResults:
        """Test POResponseResults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `POResponseResults`
        """
        model = POResponseResults()
        if include_optional:
            return POResponseResults(
    ...
    def testPOResponseResults(self):
        """Test POResponseResults"""

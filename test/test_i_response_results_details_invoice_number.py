...
class TestIResponseResultsDetailsInvoiceNumber(unittest.TestCase):
    """IResponseResultsDetailsInvoiceNumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IResponseResultsDetailsInvoiceNumber:
        """Test IResponseResultsDetailsInvoiceNumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IResponseResultsDetailsInvoiceNumber`
        """
        model = IResponseResultsDetailsInvoiceNumber()
        if include_optional:
            return IResponseResultsDetailsInvoiceNumber(
                exists = True,
                value = 'INV00001'
            )
        else:
    ...
    def testIResponseResultsDetailsInvoiceNumber(self):
        """Test IResponseResultsDetailsInvoiceNumber"""

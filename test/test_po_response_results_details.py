...
class TestPOResponseResultsDetails(unittest.TestCase):
    """POResponseResultsDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> POResponseResultsDetails:
        """Test POResponseResultsDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `POResponseResultsDetails`
        """
        model = POResponseResultsDetails()
        if include_optional:
            return POResponseResultsDetails(
    ...
    def testPOResponseResultsDetails(self):
        """Test POResponseResultsDetails"""

...
class TestModel3MBSResponseResults(unittest.TestCase):
    """Model3MBSResponseResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Model3MBSResponseResults:
        """Test Model3MBSResponseResults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Model3MBSResponseResults`
        """
        model = Model3MBSResponseResults()
        if include_optional:
            return Model3MBSResponseResults(
    ...
    def testModel3MBSResponseResults(self):
        """Test Model3MBSResponseResults"""

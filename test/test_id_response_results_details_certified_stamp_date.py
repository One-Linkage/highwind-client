...
class TestIDResponseResultsDetailsCertifiedStampDate(unittest.TestCase):
    """IDResponseResultsDetailsCertifiedStampDate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IDResponseResultsDetailsCertifiedStampDate:
        """Test IDResponseResultsDetailsCertifiedStampDate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IDResponseResultsDetailsCertifiedStampDate`
        """
        model = IDResponseResultsDetailsCertifiedStampDate()
        if include_optional:
            return IDResponseResultsDetailsCertifiedStampDate(
                exists = True,
                value = '2023-12-31'
            )
        else:
    ...
    def testIDResponseResultsDetailsCertifiedStampDate(self):
        """Test IDResponseResultsDetailsCertifiedStampDate"""

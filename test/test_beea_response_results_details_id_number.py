...
class TestBEEAResponseResultsDetailsIdNumber(unittest.TestCase):
    """BEEAResponseResultsDetailsIdNumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BEEAResponseResultsDetailsIdNumber:
        """Test BEEAResponseResultsDetailsIdNumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BEEAResponseResultsDetailsIdNumber`
        """
        model = BEEAResponseResultsDetailsIdNumber()
        if include_optional:
            return BEEAResponseResultsDetailsIdNumber(
                exists = True,
                value = '9202204720082'
            )
        else:
    ...
    def testBEEAResponseResultsDetailsIdNumber(self):
        """Test BEEAResponseResultsDetailsIdNumber"""

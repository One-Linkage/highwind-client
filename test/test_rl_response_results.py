...
class TestRLResponseResults(unittest.TestCase):
    """RLResponseResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RLResponseResults:
        """Test RLResponseResults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RLResponseResults`
        """
        model = RLResponseResults()
        if include_optional:
            return RLResponseResults(
    ...
    def testRLResponseResults(self):
        """Test RLResponseResults"""

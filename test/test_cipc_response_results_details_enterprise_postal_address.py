...
class TestCIPCResponseResultsDetailsEnterprisePostalAddress(unittest.TestCase):
    """CIPCResponseResultsDetailsEnterprisePostalAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CIPCResponseResultsDetailsEnterprisePostalAddress:
        """Test CIPCResponseResultsDetailsEnterprisePostalAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CIPCResponseResultsDetailsEnterprisePostalAddress`
        """
        model = CIPCResponseResultsDetailsEnterprisePostalAddress()
        if include_optional:
            return CIPCResponseResultsDetailsEnterprisePostalAddress(
                exists = True,
                value = 'PO Box 123'
            )
        else:
    ...
    def testCIPCResponseResultsDetailsEnterprisePostalAddress(self):
        """Test CIPCResponseResultsDetailsEnterprisePostalAddress"""

...
class TestCONResponseResults(unittest.TestCase):
    """CONResponseResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CONResponseResults:
        """Test CONResponseResults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CONResponseResults`
        """
        model = CONResponseResults()
        if include_optional:
            return CONResponseResults(
                is_contract = True,
                pages_processed = 10,
                details = highwind_client.models.con_response_results_details.CONResponse_results_details(
                    name_of_party_1 = highwind_client.models.afs_response_results_details_accountant_name.AFSResponse_results_details_accountant_name(
                        exists = True, 
                        value = 'Bob Bobbington', ), 
                    name_of_party_2 = highwind_client.models.beea_response_results_details_full_name.BEEAResponse_results_details_full_name(
                        exists = True, 
                        value = 'Moira Brown', ), 
                    date_of_agreement = highwind_client.models.bcl_response_results_details_date_issued.BCLResponse_results_details_date_issued(
                        exists = True, 
                        value = '2024-01-01', ), 
                    ...
                    service_product_description = highwind_client.models.con_response_results_details_service_product_description.CONResponse_results_details_service_product_description(
                        exists = False, 
                        value = 'Summary', ), 
                    service_product_cost_optional = highwind_client.models.con_response_results_details_service_product_cost_optional.CONResponse_results_details_service_product_cost_optional(
                        exists = False, 
                        value = 'R100,000.00', ), 
                    signatures_of_both_parties = highwind_client.models.afs_response_results_details_statement_of_financial_position.AFSResponse_results_details_statement_of_financial_position(
                        exists = True, ), ),
    ...
    def testCONResponseResults(self):
        """Test CONResponseResults"""

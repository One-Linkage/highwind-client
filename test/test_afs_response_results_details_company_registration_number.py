...
class TestAFSResponseResultsDetailsCompanyRegistrationNumber(unittest.TestCase):
    """AFSResponseResultsDetailsCompanyRegistrationNumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AFSResponseResultsDetailsCompanyRegistrationNumber:
        """Test AFSResponseResultsDetailsCompanyRegistrationNumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AFSResponseResultsDetailsCompanyRegistrationNumber`
        """
        model = AFSResponseResultsDetailsCompanyRegistrationNumber()
        if include_optional:
            return AFSResponseResultsDetailsCompanyRegistrationNumber(
                exists = True,
    ...
    def testAFSResponseResultsDetailsCompanyRegistrationNumber(self):
        """Test AFSResponseResultsDetailsCompanyRegistrationNumber"""

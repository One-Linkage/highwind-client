...
class TestModel3MBSResponseResultsDetailsStatementDatePeriod(unittest.TestCase):
    """Model3MBSResponseResultsDetailsStatementDatePeriod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Model3MBSResponseResultsDetailsStatementDatePeriod:
        """Test Model3MBSResponseResultsDetailsStatementDatePeriod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Model3MBSResponseResultsDetailsStatementDatePeriod`
        """
        model = Model3MBSResponseResultsDetailsStatementDatePeriod()
        if include_optional:
            return Model3MBSResponseResultsDetailsStatementDatePeriod(
                exists = True,
    ...
    def testModel3MBSResponseResultsDetailsStatementDatePeriod(self):
        """Test Model3MBSResponseResultsDetailsStatementDatePeriod"""

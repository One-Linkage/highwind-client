...
class TestCOPResponseResultsDetails(unittest.TestCase):
    """COPResponseResultsDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> COPResponseResultsDetails:
        """Test COPResponseResultsDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `COPResponseResultsDetails`
        """
        model = COPResponseResultsDetails()
        if include_optional:
            return COPResponseResultsDetails(
    ...
    def testCOPResponseResultsDetails(self):
        """Test COPResponseResultsDetails"""

...
class TestBEEAResponseResultsDetailsBlackOwnershipDesignatedGroupPercentage(unittest.TestCase):
    """BEEAResponseResultsDetailsBlackOwnershipDesignatedGroupPercentage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BEEAResponseResultsDetailsBlackOwnershipDesignatedGroupPercentage:
        """Test BEEAResponseResultsDetailsBlackOwnershipDesignatedGroupPercentage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BEEAResponseResultsDetailsBlackOwnershipDesignatedGroupPercentage`
        """
        model = BEEAResponseResultsDetailsBlackOwnershipDesignatedGroupPercentage()
        if include_optional:
            return BEEAResponseResultsDetailsBlackOwnershipDesignatedGroupPercentage(
                exists = False,
                value = 'NA'
            )
        else:
    ...
    def testBEEAResponseResultsDetailsBlackOwnershipDesignatedGroupPercentage(self):
        """Test BEEAResponseResultsDetailsBlackOwnershipDesignatedGroupPercentage"""

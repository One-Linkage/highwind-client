...
class TestIResponseResultsDetailsTotalAmount(unittest.TestCase):
    """IResponseResultsDetailsTotalAmount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IResponseResultsDetailsTotalAmount:
        """Test IResponseResultsDetailsTotalAmount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IResponseResultsDetailsTotalAmount`
        """
        model = IResponseResultsDetailsTotalAmount()
        if include_optional:
            return IResponseResultsDetailsTotalAmount(
                exists = True,
                value = 'R100.00'
            )
        else:
    ...
    def testIResponseResultsDetailsTotalAmount(self):
        """Test IResponseResultsDetailsTotalAmount"""

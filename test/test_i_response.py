...
class TestIResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IResponse:
        """Test IResponse
        ...
        if include_optional:
            return IResponse(
                status = 'complete',
                results = highwind_client.models.i_response_results.IResponse_results(
                    is_invoice = True, 
                    pages_processed = 10, 

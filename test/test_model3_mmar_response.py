...
class TestModel3MMARResponse(unittest.TestCase):
    """Model3MMARResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Model3MMARResponse:
        """Test Model3MMARResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Model3MMARResponse`
        """
        model = Model3MMARResponse()
        if include_optional:
            return Model3MMARResponse(
                status = 'complete',
                results = highwind_client.models._3_mmar_response_results._3MMARResponse_results(
                    is_3_month_management_account_report = True, 
                    pages_processed = 10, 
                    details = highwind_client.models._3_mmar_response_results_details._3MMARResponse_results_details(
    ...
    def testModel3MMARResponse(self):
        """Test Model3MMARResponse"""

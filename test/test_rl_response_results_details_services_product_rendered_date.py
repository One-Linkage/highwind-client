...
class TestRLResponseResultsDetailsServicesProductRenderedDate(unittest.TestCase):
    """RLResponseResultsDetailsServicesProductRenderedDate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RLResponseResultsDetailsServicesProductRenderedDate:
        """Test RLResponseResultsDetailsServicesProductRenderedDate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RLResponseResultsDetailsServicesProductRenderedDate`
        """
        model = RLResponseResultsDetailsServicesProductRenderedDate()
        if include_optional:
            return RLResponseResultsDetailsServicesProductRenderedDate(
                exists = True,
    ...
    def testRLResponseResultsDetailsServicesProductRenderedDate(self):
        """Test RLResponseResultsDetailsServicesProductRenderedDate"""

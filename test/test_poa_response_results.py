...
class TestPOAResponseResults(unittest.TestCase):
    """POAResponseResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> POAResponseResults:
        """Test POAResponseResults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `POAResponseResults`
        """
        model = POAResponseResults()
        if include_optional:
            return POAResponseResults(
                is_proof_of_address = True,
                pages_processed = 10,
                details = highwind_client.models.poa_response_results_details.POAResponse_results_details(
    ...
    def testPOAResponseResults(self):
        """Test POAResponseResults"""

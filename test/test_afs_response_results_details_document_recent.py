...
class TestAFSResponseResultsDetailsDocumentRecent(unittest.TestCase):
    """AFSResponseResultsDetailsDocumentRecent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AFSResponseResultsDetailsDocumentRecent:
        """Test AFSResponseResultsDetailsDocumentRecent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AFSResponseResultsDetailsDocumentRecent`
        """
        model = AFSResponseResultsDetailsDocumentRecent()
        if include_optional:
            return AFSResponseResultsDetailsDocumentRecent(
                exists = False,
    ...
    def testAFSResponseResultsDetailsDocumentRecent(self):
        """Test AFSResponseResultsDetailsDocumentRecent"""

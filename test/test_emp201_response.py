...
class TestEMP201Response(unittest.TestCase):
    """EMP201Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EMP201Response:
        """Test EMP201Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EMP201Response`
        """
        model = EMP201Response()
        if include_optional:
            return EMP201Response(
                status = 'complete',
                results = highwind_client.models.emp201_response_results.EMP201Response_results(
                    is_emp201 = True, 
                    pages_processed = 10, 
                    details = highwind_client.models.emp201_response_results_details.EMP201Response_results_details(
                        ...
                        certificate_number_bottom_left_corner = highwind_client.models.afs_response_results_details_statement_of_financial_position.AFSResponse_results_details_statement_of_financial_position(
                            exists = True, ), 
                        company_trading_contact_details = , ), 

...
class TestLGSResponseResultsDetails(unittest.TestCase):
    """LGSResponseResultsDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LGSResponseResultsDetails:
        """Test LGSResponseResultsDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LGSResponseResultsDetails`
        """
        model = LGSResponseResultsDetails()
        if include_optional:
            return LGSResponseResultsDetails(
    ...
    def testLGSResponseResultsDetails(self):
        """Test LGSResponseResultsDetails"""

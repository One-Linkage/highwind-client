...
class TestCIPCResponseResultsDetails(unittest.TestCase):
    """CIPCResponseResultsDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CIPCResponseResultsDetails:
        """Test CIPCResponseResultsDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CIPCResponseResultsDetails`
        """
        model = CIPCResponseResultsDetails()
        if include_optional:
            return CIPCResponseResultsDetails(
                ...
                registration_date = highwind_client.models.bcl_response_results_details_date_issued.BCLResponse_results_details_date_issued(
                    exists = True, 
                    value = '2024-01-01', ),
                business_start_date = highwind_client.models.bcl_response_results_details_date_issued.BCLResponse_results_details_date_issued(
                    exists = True, 
                    value = '2024-01-01', ),
    ...
    def testCIPCResponseResultsDetails(self):
        """Test CIPCResponseResultsDetails"""

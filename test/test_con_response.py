...
class TestCONResponse(unittest.TestCase):
    """CONResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CONResponse:
        """Test CONResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CONResponse`
        """
        model = CONResponse()
        if include_optional:
            return CONResponse(
                status = 'complete',
                results = highwind_client.models.con_response_results.CONResponse_results(
                    is_contract = True, 
                    pages_processed = 10, 

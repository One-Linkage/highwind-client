...
class TestPOAResponseResultsDetailsDocumentDate(unittest.TestCase):
    """POAResponseResultsDetailsDocumentDate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> POAResponseResultsDetailsDocumentDate:
        """Test POAResponseResultsDetailsDocumentDate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `POAResponseResultsDetailsDocumentDate`
        """
        model = POAResponseResultsDetailsDocumentDate()
        if include_optional:
            return POAResponseResultsDetailsDocumentDate(
                exists = True,
                value = '2023-12-30'
            )
        else:
    ...
    def testPOAResponseResultsDetailsDocumentDate(self):
        """Test POAResponseResultsDetailsDocumentDate"""

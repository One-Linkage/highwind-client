...
class TestAFSResponseResultsDetails(unittest.TestCase):
    """AFSResponseResultsDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AFSResponseResultsDetails:
        """Test AFSResponseResultsDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AFSResponseResultsDetails`
        """
        model = AFSResponseResultsDetails()
        if include_optional:
            return AFSResponseResultsDetails(
                company_name = highwind_client.models.afs_response_results_details_company_name.AFSResponse_results_details_company_name(
                    exists = True, 
                    value = 'Name of the company', ),
                company_registration_number = highwind_client.models.afs_response_results_details_company_registration_number.AFSResponse_results_details_company_registration_number(
                    exists = True, 
                    value = 'Registration number of the company', ),
                period = highwind_client.models.afs_response_results_details_period.AFSResponse_results_details_period(
                    exists = True, 
                    value = 'for the year ended February 28, 2023', ),
                ...
                statement_of_financial_position = highwind_client.models.afs_response_results_details_statement_of_financial_position.AFSResponse_results_details_statement_of_financial_position(
                    exists = True, ),
                statement_of_profit_and_loss = highwind_client.models.afs_response_results_details_statement_of_financial_position.AFSResponse_results_details_statement_of_financial_position(
                    exists = True, ),
                statement_of_changes_in_equity = highwind_client.models.afs_response_results_details_statement_of_financial_position.AFSResponse_results_details_statement_of_financial_position(
                    exists = True, ),
                statement_of_cash_flow = highwind_client.models.afs_response_results_details_statement_of_financial_position.AFSResponse_results_details_statement_of_financial_position(
                    exists = True, ),
                director_name = highwind_client.models.afs_response_results_details_director_name.AFSResponse_results_details_director_name(
                    exists = True, 
                    value = 'John Smith', ),
                director_signature = highwind_client.models.afs_response_results_details_statement_of_financial_position.AFSResponse_results_details_statement_of_financial_position(
                    exists = True, ),
                accountant_name = highwind_client.models.afs_response_results_details_accountant_name.AFSResponse_results_details_accountant_name(
                    exists = True, 
                    value = 'Bob Bobbington', ),
                accountant_signature = highwind_client.models.afs_response_results_details_statement_of_financial_position.AFSResponse_results_details_statement_of_financial_position(
                    exists = True, )
            )
        else:
            return AFSResponseResultsDetails(
    ...
    def testAFSResponseResultsDetails(self):
        """Test AFSResponseResultsDetails"""

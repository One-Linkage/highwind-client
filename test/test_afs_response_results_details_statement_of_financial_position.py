...
class TestAFSResponseResultsDetailsStatementOfFinancialPosition(unittest.TestCase):
    """AFSResponseResultsDetailsStatementOfFinancialPosition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AFSResponseResultsDetailsStatementOfFinancialPosition:
        """Test AFSResponseResultsDetailsStatementOfFinancialPosition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AFSResponseResultsDetailsStatementOfFinancialPosition`
        """
        model = AFSResponseResultsDetailsStatementOfFinancialPosition()
        if include_optional:
            return AFSResponseResultsDetailsStatementOfFinancialPosition(
                exists = True
            )
        else:
            return AFSResponseResultsDetailsStatementOfFinancialPosition(
    ...
    def testAFSResponseResultsDetailsStatementOfFinancialPosition(self):
        """Test AFSResponseResultsDetailsStatementOfFinancialPosition"""

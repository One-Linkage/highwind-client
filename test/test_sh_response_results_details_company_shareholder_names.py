...
class TestSHResponseResultsDetailsCompanyShareholderNames(unittest.TestCase):
    """SHResponseResultsDetailsCompanyShareholderNames unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SHResponseResultsDetailsCompanyShareholderNames:
        """Test SHResponseResultsDetailsCompanyShareholderNames
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SHResponseResultsDetailsCompanyShareholderNames`
        """
        model = SHResponseResultsDetailsCompanyShareholderNames()
        if include_optional:
            return SHResponseResultsDetailsCompanyShareholderNames(
                exists = True,
    ...
    def testSHResponseResultsDetailsCompanyShareholderNames(self):
        """Test SHResponseResultsDetailsCompanyShareholderNames"""

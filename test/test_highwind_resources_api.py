...
from highwind_client.api.highwind_resources_api import HighwindResourcesApi


class TestHighwindResourcesApi(unittest.TestCase):
    """HighwindResourcesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = HighwindResourcesApi()

    def tearDown(self) -> None:
        pass

    def test_v3_verify_get_results_object_get(self) -> None:
        """Test case for v3_verify_get_results_object_get

        Return the result of the analysed PDF. Requires the `task_id` from `get_upload_url`.
        """
        pass

    def test_v3_verify_get_results_object_options(self) -> None:
        """Test case for v3_verify_get_results_object_options

        """
        pass

    def test_v3_verify_get_upload_url_object_get(self) -> None:
        """Test case for v3_verify_get_upload_url_object_get

        Generates a presigned URL for uploading to the storage system.
        """
        pass

    def test_v3_verify_get_upload_url_object_options(self) -> None:
        """Test case for v3_verify_get_upload_url_object_options

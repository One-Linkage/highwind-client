...
class TestPOResponseResultsDetailsPurchaseOrderNumber(unittest.TestCase):
    """POResponseResultsDetailsPurchaseOrderNumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> POResponseResultsDetailsPurchaseOrderNumber:
        """Test POResponseResultsDetailsPurchaseOrderNumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `POResponseResultsDetailsPurchaseOrderNumber`
        """
        model = POResponseResultsDetailsPurchaseOrderNumber()
        if include_optional:
            return POResponseResultsDetailsPurchaseOrderNumber(
                exists = True,
                value = 'PO1234ABC'
            )
        else:
    ...
    def testPOResponseResultsDetailsPurchaseOrderNumber(self):
        """Test POResponseResultsDetailsPurchaseOrderNumber"""

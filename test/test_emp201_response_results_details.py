...
class TestEMP201ResponseResultsDetails(unittest.TestCase):
    """EMP201ResponseResultsDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EMP201ResponseResultsDetails:
        """Test EMP201ResponseResultsDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EMP201ResponseResultsDetails`
        """
        model = EMP201ResponseResultsDetails()
        if include_optional:
            return EMP201ResponseResultsDetails(
                emp201_text_top_right_corner = highwind_client.models.afs_response_results_details_statement_of_financial_position.AFSResponse_results_details_statement_of_financial_position(
                    exists = True, ),
                company_trading_name = highwind_client.models.po_response_results_details_vendor_name.POResponse_results_details_vendor_name(
                    exists = True, 
                    value = 'Megaton Supplies', ),
                paye_reference_number = highwind_client.models.emp201_response_results_details_paye_reference_number.EMP201Response_results_details_paye_reference_number(
                    exists = True, 
                    value = '1234ABC', ),
                sdl_reference_number_optional = highwind_client.models.emp201_response_results_details_sdl_reference_number_optional.EMP201Response_results_details_sdl_reference_number_optional(
                    exists = True, 
                    value = 'NA', ),
                uif_reference_number = highwind_client.models.emp201_response_results_details_paye_reference_number.EMP201Response_results_details_paye_reference_number(
                    exists = True, 
                    value = '1234ABC', ),
                declaration_date = highwind_client.models.emp201_response_results_details_declaration_date.EMP201Response_results_details_declaration_date(
                    exists = False, 
                    value = '2024-01-01', ),
                ...
                certificate_number_bottom_left_corner = highwind_client.models.afs_response_results_details_statement_of_financial_position.AFSResponse_results_details_statement_of_financial_position(
                    exists = True, ),
                company_trading_contact_details = highwind_client.models.afs_response_results_details_statement_of_financial_position.AFSResponse_results_details_statement_of_financial_position(
                    exists = True, )
            )
        else:
            return EMP201ResponseResultsDetails(
    ...
    def testEMP201ResponseResultsDetails(self):
        """Test EMP201ResponseResultsDetails"""

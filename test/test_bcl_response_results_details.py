...
class TestBCLResponseResultsDetails(unittest.TestCase):
    """BCLResponseResultsDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BCLResponseResultsDetails:
        """Test BCLResponseResultsDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BCLResponseResultsDetails`
        """
        model = BCLResponseResultsDetails()
        if include_optional:
            return BCLResponseResultsDetails(
    ...
    def testBCLResponseResultsDetails(self):
        """Test BCLResponseResultsDetails"""

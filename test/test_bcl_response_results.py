...
class TestBCLResponseResults(unittest.TestCase):
    """BCLResponseResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BCLResponseResults:
        """Test BCLResponseResults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BCLResponseResults`
        """
        model = BCLResponseResults()
        if include_optional:
            return BCLResponseResults(
                is_bank_confirmation_letter = True,
                pages_processed = 10,
                details = highwind_client.models.bcl_response_results_details.BCLResponse_results_details(
                    bank_name = highwind_client.models._3_mbs_response_results_details_bank_name._3MBSResponse_results_details_bank_name(
                        exists = True, 
                        value = 'Vault 76 Bank', ), 
                    bank_branch_code = highwind_client.models.bcl_response_results_details_bank_branch_code.BCLResponse_results_details_bank_branch_code(
                        exists = True, 
                        value = '1234ABCD', ), 
                    ...
                    company_account_number = highwind_client.models.bcl_response_results_details_bank_branch_code.BCLResponse_results_details_bank_branch_code(
                        exists = True, 
                        value = '1234ABCD', ), 
                    date_issued = highwind_client.models.bcl_response_results_details_date_issued.BCLResponse_results_details_date_issued(
                        exists = True, 
                        value = '2024-01-01', ), 
                    ...
                    verification_statement = highwind_client.models.bcl_response_results_details_verification_statement.BCLResponse_results_details_verification_statement(
                        exists = True, 
                        value = 'Summary', ), ),
    ...
    def testBCLResponseResults(self):
        """Test BCLResponseResults"""

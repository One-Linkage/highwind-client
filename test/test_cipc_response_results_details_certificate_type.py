...
class TestCIPCResponseResultsDetailsCertificateType(unittest.TestCase):
    """CIPCResponseResultsDetailsCertificateType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CIPCResponseResultsDetailsCertificateType:
        """Test CIPCResponseResultsDetailsCertificateType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CIPCResponseResultsDetailsCertificateType`
        """
        model = CIPCResponseResultsDetailsCertificateType()
        if include_optional:
            return CIPCResponseResultsDetailsCertificateType(
                exists = True,
                value = 'CoR 30.1'
            )
        else:
    ...
    def testCIPCResponseResultsDetailsCertificateType(self):
        """Test CIPCResponseResultsDetailsCertificateType"""

...
class TestBEEAResponseResults(unittest.TestCase):
    """BEEAResponseResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BEEAResponseResults:
        """Test BEEAResponseResults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BEEAResponseResults`
        """
        model = BEEAResponseResults()
        if include_optional:
            return BEEAResponseResults(
                is_bee_affidavit = True,
                pages_processed = 10,
                details = highwind_client.models.beea_response_results_details.BEEAResponse_results_details(
                    ...
                    commissioner_of_oaths_stamp_signature = highwind_client.models.afs_response_results_details_statement_of_financial_position.AFSResponse_results_details_statement_of_financial_position(
                        exists = True, ), 
                    commissioner_of_oaths_stamp_signature_date = , 
    ...
    def testBEEAResponseResults(self):
        """Test BEEAResponseResults"""

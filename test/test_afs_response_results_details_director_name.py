...
class TestAFSResponseResultsDetailsDirectorName(unittest.TestCase):
    """AFSResponseResultsDetailsDirectorName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AFSResponseResultsDetailsDirectorName:
        """Test AFSResponseResultsDetailsDirectorName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AFSResponseResultsDetailsDirectorName`
        """
        model = AFSResponseResultsDetailsDirectorName()
        if include_optional:
            return AFSResponseResultsDetailsDirectorName(
                exists = True,
                value = 'John Smith'
            )
        else:
    ...
    def testAFSResponseResultsDetailsDirectorName(self):
        """Test AFSResponseResultsDetailsDirectorName"""

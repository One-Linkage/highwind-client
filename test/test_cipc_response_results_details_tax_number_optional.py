...
class TestCIPCResponseResultsDetailsTaxNumberOptional(unittest.TestCase):
    """CIPCResponseResultsDetailsTaxNumberOptional unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CIPCResponseResultsDetailsTaxNumberOptional:
        """Test CIPCResponseResultsDetailsTaxNumberOptional
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CIPCResponseResultsDetailsTaxNumberOptional`
        """
        model = CIPCResponseResultsDetailsTaxNumberOptional()
        if include_optional:
            return CIPCResponseResultsDetailsTaxNumberOptional(
                exists = True,
                value = '12345'
            )
        else:
    ...
    def testCIPCResponseResultsDetailsTaxNumberOptional(self):
        """Test CIPCResponseResultsDetailsTaxNumberOptional"""

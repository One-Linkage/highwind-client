...
class TestPOAResponseResultsDetailsAddressMunicipalDistrictOptional(unittest.TestCase):
    """POAResponseResultsDetailsAddressMunicipalDistrictOptional unit test stubs"""
    ...
    def make_instance(self, include_optional) -> POAResponseResultsDetailsAddressMunicipalDistrictOptional:
        """Test POAResponseResultsDetailsAddressMunicipalDistrictOptional
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `POAResponseResultsDetailsAddressMunicipalDistrictOptional`
        """
        model = POAResponseResultsDetailsAddressMunicipalDistrictOptional()
        if include_optional:
            return POAResponseResultsDetailsAddressMunicipalDistrictOptional(
                exists = True,
    ...
    def testPOAResponseResultsDetailsAddressMunicipalDistrictOptional(self):
        """Test POAResponseResultsDetailsAddressMunicipalDistrictOptional"""

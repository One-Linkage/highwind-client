...
class TestBEECResponseResultsDetailsEnterpriseRegistrationNumber(unittest.TestCase):
    """BEECResponseResultsDetailsEnterpriseRegistrationNumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BEECResponseResultsDetailsEnterpriseRegistrationNumber:
        """Test BEECResponseResultsDetailsEnterpriseRegistrationNumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BEECResponseResultsDetailsEnterpriseRegistrationNumber`
        """
        model = BEECResponseResultsDetailsEnterpriseRegistrationNumber()
        if include_optional:
            return BEECResponseResultsDetailsEnterpriseRegistrationNumber(
                exists = True,
                value = '123ABC'
            )
        else:
    ...
    def testBEECResponseResultsDetailsEnterpriseRegistrationNumber(self):
        """Test BEECResponseResultsDetailsEnterpriseRegistrationNumber"""

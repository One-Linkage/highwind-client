...
class TestBCLResponseResultsDetailsVerificationStatement(unittest.TestCase):
    """BCLResponseResultsDetailsVerificationStatement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BCLResponseResultsDetailsVerificationStatement:
        """Test BCLResponseResultsDetailsVerificationStatement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BCLResponseResultsDetailsVerificationStatement`
        """
        model = BCLResponseResultsDetailsVerificationStatement()
        if include_optional:
            return BCLResponseResultsDetailsVerificationStatement(
                exists = True,
                value = 'Summary'
            )
        else:
    ...
    def testBCLResponseResultsDetailsVerificationStatement(self):
        """Test BCLResponseResultsDetailsVerificationStatement"""

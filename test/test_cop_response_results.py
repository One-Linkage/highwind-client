...
class TestCOPResponseResults(unittest.TestCase):
    """COPResponseResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> COPResponseResults:
        """Test COPResponseResults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `COPResponseResults`
        """
        model = COPResponseResults()
        if include_optional:
            return COPResponseResults(
                is_company_profile = True,
                pages_processed = 10,
                details = highwind_client.models.cop_response_results_details.COPResponse_results_details(
                    company_name = highwind_client.models.po_response_results_details_customer_name.POResponse_results_details_customer_name(
                        exists = True, 
                        value = 'Happy Shops', ), 
                    company_address_optional = highwind_client.models.lgs_response_results_details_company_address.LGSResponse_results_details_company_address(
                        exists = True, 
                        value = '123 Happy Street', ), 
                    company_services_products = highwind_client.models.bcl_response_results_details_verification_statement.BCLResponse_results_details_verification_statement(
                        exists = True, 
                        value = 'Summary', ), ),
    ...
    def testCOPResponseResults(self):
        """Test COPResponseResults"""

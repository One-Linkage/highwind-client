...
class TestTCCResponseResultsDetailsRequestReferenceNumber(unittest.TestCase):
    """TCCResponseResultsDetailsRequestReferenceNumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TCCResponseResultsDetailsRequestReferenceNumber:
        """Test TCCResponseResultsDetailsRequestReferenceNumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TCCResponseResultsDetailsRequestReferenceNumber`
        """
        model = TCCResponseResultsDetailsRequestReferenceNumber()
        if include_optional:
            return TCCResponseResultsDetailsRequestReferenceNumber(
                exists = False,
                value = '123ABC'
            )
        else:
    ...
    def testTCCResponseResultsDetailsRequestReferenceNumber(self):
        """Test TCCResponseResultsDetailsRequestReferenceNumber"""

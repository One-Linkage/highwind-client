...
class TestTCCResponseResults(unittest.TestCase):
    """TCCResponseResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TCCResponseResults:
        """Test TCCResponseResults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TCCResponseResults`
        """
        model = TCCResponseResults()
        if include_optional:
            return TCCResponseResults(
    ...
    def testTCCResponseResults(self):
        """Test TCCResponseResults"""

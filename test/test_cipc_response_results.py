...
class TestCIPCResponseResults(unittest.TestCase):
    """CIPCResponseResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CIPCResponseResults:
        """Test CIPCResponseResults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CIPCResponseResults`
        """
        model = CIPCResponseResults()
        if include_optional:
            return CIPCResponseResults(
                is_cipc = True,
                pages_processed = 10,
    ...
    def testCIPCResponseResults(self):
        """Test CIPCResponseResults"""

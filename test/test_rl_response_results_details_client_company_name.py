...
class TestRLResponseResultsDetailsClientCompanyName(unittest.TestCase):
    """RLResponseResultsDetailsClientCompanyName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RLResponseResultsDetailsClientCompanyName:
        """Test RLResponseResultsDetailsClientCompanyName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RLResponseResultsDetailsClientCompanyName`
        """
        model = RLResponseResultsDetailsClientCompanyName()
        if include_optional:
            return RLResponseResultsDetailsClientCompanyName(
                exists = True,
    ...
    def testRLResponseResultsDetailsClientCompanyName(self):
        """Test RLResponseResultsDetailsClientCompanyName"""

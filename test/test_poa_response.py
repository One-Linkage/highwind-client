...
class TestPOAResponse(unittest.TestCase):
    """POAResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> POAResponse:
        """Test POAResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `POAResponse`
        """
        model = POAResponse()
        if include_optional:
            return POAResponse(
                status = 'complete',
                results = highwind_client.models.poa_response_results.POAResponse_results(

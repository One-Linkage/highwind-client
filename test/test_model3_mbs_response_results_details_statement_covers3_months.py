...
class TestModel3MBSResponseResultsDetailsStatementCovers3Months(unittest.TestCase):
    """Model3MBSResponseResultsDetailsStatementCovers3Months unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Model3MBSResponseResultsDetailsStatementCovers3Months:
        """Test Model3MBSResponseResultsDetailsStatementCovers3Months
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Model3MBSResponseResultsDetailsStatementCovers3Months`
        """
        model = Model3MBSResponseResultsDetailsStatementCovers3Months()
        if include_optional:
            return Model3MBSResponseResultsDetailsStatementCovers3Months(
                exists = True,
    ...
    def testModel3MBSResponseResultsDetailsStatementCovers3Months(self):
        """Test Model3MBSResponseResultsDetailsStatementCovers3Months"""

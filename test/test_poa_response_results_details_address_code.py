...
class TestPOAResponseResultsDetailsAddressCode(unittest.TestCase):
    """POAResponseResultsDetailsAddressCode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> POAResponseResultsDetailsAddressCode:
        """Test POAResponseResultsDetailsAddressCode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `POAResponseResultsDetailsAddressCode`
        """
        model = POAResponseResultsDetailsAddressCode()
        if include_optional:
            return POAResponseResultsDetailsAddressCode(
                exists = True,
                value = '2001'
            )
        else:
    ...
    def testPOAResponseResultsDetailsAddressCode(self):
        """Test POAResponseResultsDetailsAddressCode"""

...
class TestCIPCResponseResultsDetailsFinancialYearEnd(unittest.TestCase):
    """CIPCResponseResultsDetailsFinancialYearEnd unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CIPCResponseResultsDetailsFinancialYearEnd:
        """Test CIPCResponseResultsDetailsFinancialYearEnd
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CIPCResponseResultsDetailsFinancialYearEnd`
        """
        model = CIPCResponseResultsDetailsFinancialYearEnd()
        if include_optional:
            return CIPCResponseResultsDetailsFinancialYearEnd(
                exists = True,
                value = 'April'
            )
        else:
    ...
    def testCIPCResponseResultsDetailsFinancialYearEnd(self):
        """Test CIPCResponseResultsDetailsFinancialYearEnd"""

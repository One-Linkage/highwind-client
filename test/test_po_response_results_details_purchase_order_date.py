...
class TestPOResponseResultsDetailsPurchaseOrderDate(unittest.TestCase):
    """POResponseResultsDetailsPurchaseOrderDate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> POResponseResultsDetailsPurchaseOrderDate:
        """Test POResponseResultsDetailsPurchaseOrderDate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `POResponseResultsDetailsPurchaseOrderDate`
        """
        model = POResponseResultsDetailsPurchaseOrderDate()
        if include_optional:
            return POResponseResultsDetailsPurchaseOrderDate(
                exists = True,
                value = '2024/02/24'
            )
        else:
    ...
    def testPOResponseResultsDetailsPurchaseOrderDate(self):
        """Test POResponseResultsDetailsPurchaseOrderDate"""

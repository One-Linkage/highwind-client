...
class TestCIPCResponseResultsDetailsRegistrationNumber(unittest.TestCase):
    """CIPCResponseResultsDetailsRegistrationNumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CIPCResponseResultsDetailsRegistrationNumber:
        """Test CIPCResponseResultsDetailsRegistrationNumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CIPCResponseResultsDetailsRegistrationNumber`
        """
        model = CIPCResponseResultsDetailsRegistrationNumber()
        if include_optional:
            return CIPCResponseResultsDetailsRegistrationNumber(
                exists = False,
    ...
    def testCIPCResponseResultsDetailsRegistrationNumber(self):
        """Test CIPCResponseResultsDetailsRegistrationNumber"""

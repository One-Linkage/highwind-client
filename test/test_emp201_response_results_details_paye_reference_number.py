...
class TestEMP201ResponseResultsDetailsPayeReferenceNumber(unittest.TestCase):
    """EMP201ResponseResultsDetailsPayeReferenceNumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EMP201ResponseResultsDetailsPayeReferenceNumber:
        """Test EMP201ResponseResultsDetailsPayeReferenceNumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EMP201ResponseResultsDetailsPayeReferenceNumber`
        """
        model = EMP201ResponseResultsDetailsPayeReferenceNumber()
        if include_optional:
            return EMP201ResponseResultsDetailsPayeReferenceNumber(
                exists = True,
                value = '1234ABC'
            )
        else:
    ...
    def testEMP201ResponseResultsDetailsPayeReferenceNumber(self):
        """Test EMP201ResponseResultsDetailsPayeReferenceNumber"""

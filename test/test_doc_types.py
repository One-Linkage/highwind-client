...
class TestDocTypes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DocTypes:
        """Test DocTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocTypes`
        """
        model = DocTypes()
        if include_optional:
            return DocTypes(
                object = 'My pdf file REF 123456ABCD',
                type = 'afs'
            )
        else:
            return DocTypes(

...
class TestCONResponseResultsDetailsServiceProductDescription(unittest.TestCase):
    """CONResponseResultsDetailsServiceProductDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CONResponseResultsDetailsServiceProductDescription:
        """Test CONResponseResultsDetailsServiceProductDescription
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CONResponseResultsDetailsServiceProductDescription`
        """
        model = CONResponseResultsDetailsServiceProductDescription()
        if include_optional:
            return CONResponseResultsDetailsServiceProductDescription(
                exists = False,
                value = 'Summary'
            )
        else:
    ...
    def testCONResponseResultsDetailsServiceProductDescription(self):
        """Test CONResponseResultsDetailsServiceProductDescription"""

...
class TestPOAResponseResultsDetailsAddressSuburb(unittest.TestCase):
    """POAResponseResultsDetailsAddressSuburb unit test stubs"""
    ...
    def make_instance(self, include_optional) -> POAResponseResultsDetailsAddressSuburb:
        """Test POAResponseResultsDetailsAddressSuburb
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `POAResponseResultsDetailsAddressSuburb`
        """
        model = POAResponseResultsDetailsAddressSuburb()
        if include_optional:
            return POAResponseResultsDetailsAddressSuburb(
                exists = True,
                value = 'Newtown'
            )
        else:
    ...
    def testPOAResponseResultsDetailsAddressSuburb(self):
        """Test POAResponseResultsDetailsAddressSuburb"""

...
class TestAFSResponseResultsDetailsCompanyName(unittest.TestCase):
    """AFSResponseResultsDetailsCompanyName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AFSResponseResultsDetailsCompanyName:
        """Test AFSResponseResultsDetailsCompanyName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AFSResponseResultsDetailsCompanyName`
        """
        model = AFSResponseResultsDetailsCompanyName()
        if include_optional:
            return AFSResponseResultsDetailsCompanyName(
                exists = True,
    ...
    def testAFSResponseResultsDetailsCompanyName(self):
        """Test AFSResponseResultsDetailsCompanyName"""

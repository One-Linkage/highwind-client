...
class TestPOResponseResultsDetailsVendorName(unittest.TestCase):
    """POResponseResultsDetailsVendorName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> POResponseResultsDetailsVendorName:
        """Test POResponseResultsDetailsVendorName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `POResponseResultsDetailsVendorName`
        """
        model = POResponseResultsDetailsVendorName()
        if include_optional:
            return POResponseResultsDetailsVendorName(
                exists = True,
    ...
    def testPOResponseResultsDetailsVendorName(self):
        """Test POResponseResultsDetailsVendorName"""

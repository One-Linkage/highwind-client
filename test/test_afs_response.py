...
class TestAFSResponse(unittest.TestCase):
    """AFSResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AFSResponse:
        """Test AFSResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AFSResponse`
        """
        model = AFSResponse()
        if include_optional:
            return AFSResponse(
                status = 'complete',
                results = highwind_client.models.afs_response_results.AFSResponse_results(
                    is_afs = True, 
                    pages_processed = 10, 

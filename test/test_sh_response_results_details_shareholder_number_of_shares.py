...
class TestSHResponseResultsDetailsShareholderNumberOfShares(unittest.TestCase):
    """SHResponseResultsDetailsShareholderNumberOfShares unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SHResponseResultsDetailsShareholderNumberOfShares:
        """Test SHResponseResultsDetailsShareholderNumberOfShares
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SHResponseResultsDetailsShareholderNumberOfShares`
        """
        model = SHResponseResultsDetailsShareholderNumberOfShares()
        if include_optional:
            return SHResponseResultsDetailsShareholderNumberOfShares(
                exists = True,
    ...
    def testSHResponseResultsDetailsShareholderNumberOfShares(self):
        """Test SHResponseResultsDetailsShareholderNumberOfShares"""

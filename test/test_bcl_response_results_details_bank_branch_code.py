...
class TestBCLResponseResultsDetailsBankBranchCode(unittest.TestCase):
    """BCLResponseResultsDetailsBankBranchCode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BCLResponseResultsDetailsBankBranchCode:
        """Test BCLResponseResultsDetailsBankBranchCode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BCLResponseResultsDetailsBankBranchCode`
        """
        model = BCLResponseResultsDetailsBankBranchCode()
        if include_optional:
            return BCLResponseResultsDetailsBankBranchCode(
                exists = True,
                value = '1234ABCD'
            )
        else:
    ...
    def testBCLResponseResultsDetailsBankBranchCode(self):
        """Test BCLResponseResultsDetailsBankBranchCode"""

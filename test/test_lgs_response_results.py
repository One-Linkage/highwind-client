...
class TestLGSResponseResults(unittest.TestCase):
    """LGSResponseResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LGSResponseResults:
        """Test LGSResponseResults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LGSResponseResults`
        """
        model = LGSResponseResults()
        if include_optional:
            return LGSResponseResults(
                is_certified_lgs = True,
                pages_processed = 10,
                details = highwind_client.models.lgs_response_results_details.LGSResponse_results_details(
                    company_name = highwind_client.models.po_response_results_details_customer_name.POResponse_results_details_customer_name(
                        exists = True, 
                        value = 'Happy Shops', ), 
                    ...
                    company_nature_of_business = highwind_client.models.bcl_response_results_details_verification_statement.BCLResponse_results_details_verification_statement(
                        exists = True, 
                        value = 'Summary', ), 
                    ...
                    lgs_in_subject_line = highwind_client.models.afs_response_results_details_statement_of_financial_position.AFSResponse_results_details_statement_of_financial_position(
                        exists = True, ), ),
    ...
    def testLGSResponseResults(self):
        """Test LGSResponseResults"""

...
class TestIDResponseResults(unittest.TestCase):
    """IDResponseResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IDResponseResults:
        """Test IDResponseResults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IDResponseResults`
        """
        model = IDResponseResults()
        if include_optional:
            return IDResponseResults(
                is_certified_id = True,
                pages_processed = 10,
                details = highwind_client.models.id_response_results_details.IDResponse_results_details(
                    valid_document_type = highwind_client.models.afs_response_results_details_statement_of_financial_position.AFSResponse_results_details_statement_of_financial_position(
                        exists = True, ), 
                    full_name = highwind_client.models.afs_response_results_details_accountant_name.AFSResponse_results_details_accountant_name(
                        exists = True, 
                    ...
                    id_number = highwind_client.models.beea_response_results_details_id_number.BEEAResponse_results_details_id_number(
                        exists = True, 
                        value = '9202204720082', ), 
                    certified_stamp = highwind_client.models.afs_response_results_details_statement_of_financial_position.AFSResponse_results_details_statement_of_financial_position(
                        exists = True, ), 
                    certified_stamp_date = highwind_client.models.id_response_results_details_certified_stamp_date.IDResponse_results_details_certified_stamp_date(
                        exists = True, 
                        value = '2023-12-31', ), 
    ...
    def testIDResponseResults(self):
        """Test IDResponseResults"""

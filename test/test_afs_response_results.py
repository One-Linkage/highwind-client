...
class TestAFSResponseResults(unittest.TestCase):
    """AFSResponseResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AFSResponseResults:
        """Test AFSResponseResults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AFSResponseResults`
        """
        model = AFSResponseResults()
        if include_optional:
            return AFSResponseResults(
                is_afs = True,
                pages_processed = 10,
                details = highwind_client.models.afs_response_results_details.AFSResponse_results_details(
    ...
    def testAFSResponseResults(self):
        """Test AFSResponseResults"""

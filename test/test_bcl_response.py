...
class TestBCLResponse(unittest.TestCase):
    """BCLResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BCLResponse:
        """Test BCLResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BCLResponse`
        """
        model = BCLResponse()
        if include_optional:
            return BCLResponse(
                status = 'complete',
                results = highwind_client.models.bcl_response_results.BCLResponse_results(

...
class TestModel3MMARResponseResults(unittest.TestCase):
    """Model3MMARResponseResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Model3MMARResponseResults:
        """Test Model3MMARResponseResults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Model3MMARResponseResults`
        """
        model = Model3MMARResponseResults()
        if include_optional:
            return Model3MMARResponseResults(
    ...
    def testModel3MMARResponseResults(self):
        """Test Model3MMARResponseResults"""

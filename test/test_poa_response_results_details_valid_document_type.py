...
class TestPOAResponseResultsDetailsValidDocumentType(unittest.TestCase):
    """POAResponseResultsDetailsValidDocumentType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> POAResponseResultsDetailsValidDocumentType:
        """Test POAResponseResultsDetailsValidDocumentType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `POAResponseResultsDetailsValidDocumentType`
        """
        model = POAResponseResultsDetailsValidDocumentType()
        if include_optional:
            return POAResponseResultsDetailsValidDocumentType(
                exists = True,
    ...
    def testPOAResponseResultsDetailsValidDocumentType(self):
        """Test POAResponseResultsDetailsValidDocumentType"""

...
class TestPOAResponseResultsDetailsAddressCityTown(unittest.TestCase):
    """POAResponseResultsDetailsAddressCityTown unit test stubs"""
    ...
    def make_instance(self, include_optional) -> POAResponseResultsDetailsAddressCityTown:
        """Test POAResponseResultsDetailsAddressCityTown
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `POAResponseResultsDetailsAddressCityTown`
        """
        model = POAResponseResultsDetailsAddressCityTown()
        if include_optional:
            return POAResponseResultsDetailsAddressCityTown(
                exists = True,
                value = 'Johannesburg'
            )
        else:
    ...
    def testPOAResponseResultsDetailsAddressCityTown(self):
        """Test POAResponseResultsDetailsAddressCityTown"""

...
class TestAFSResponseResultsDetailsAccountantName(unittest.TestCase):
    """AFSResponseResultsDetailsAccountantName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AFSResponseResultsDetailsAccountantName:
        """Test AFSResponseResultsDetailsAccountantName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AFSResponseResultsDetailsAccountantName`
        """
        model = AFSResponseResultsDetailsAccountantName()
        if include_optional:
            return AFSResponseResultsDetailsAccountantName(
                exists = True,
    ...
    def testAFSResponseResultsDetailsAccountantName(self):
        """Test AFSResponseResultsDetailsAccountantName"""

...
class TestTCCResponseResultsDetailsTaxComplianceStatus(unittest.TestCase):
    """TCCResponseResultsDetailsTaxComplianceStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TCCResponseResultsDetailsTaxComplianceStatus:
        """Test TCCResponseResultsDetailsTaxComplianceStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TCCResponseResultsDetailsTaxComplianceStatus`
        """
        model = TCCResponseResultsDetailsTaxComplianceStatus()
        if include_optional:
            return TCCResponseResultsDetailsTaxComplianceStatus(
                exists = False,
                value = 'PIN Issued.'
            )
        else:
    ...
    def testTCCResponseResultsDetailsTaxComplianceStatus(self):
        """Test TCCResponseResultsDetailsTaxComplianceStatus"""

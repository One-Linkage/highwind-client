...
class TestCIPCResponseResultsDetailsEnterpriseType(unittest.TestCase):
    """CIPCResponseResultsDetailsEnterpriseType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CIPCResponseResultsDetailsEnterpriseType:
        """Test CIPCResponseResultsDetailsEnterpriseType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CIPCResponseResultsDetailsEnterpriseType`
        """
        model = CIPCResponseResultsDetailsEnterpriseType()
        if include_optional:
            return CIPCResponseResultsDetailsEnterpriseType(
                exists = True,
    ...
    def testCIPCResponseResultsDetailsEnterpriseType(self):
        """Test CIPCResponseResultsDetailsEnterpriseType"""

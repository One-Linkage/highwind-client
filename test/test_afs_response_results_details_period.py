...
class TestAFSResponseResultsDetailsPeriod(unittest.TestCase):
    """AFSResponseResultsDetailsPeriod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AFSResponseResultsDetailsPeriod:
        """Test AFSResponseResultsDetailsPeriod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AFSResponseResultsDetailsPeriod`
        """
        model = AFSResponseResultsDetailsPeriod()
        if include_optional:
            return AFSResponseResultsDetailsPeriod(
                exists = True,
    ...
    def testAFSResponseResultsDetailsPeriod(self):
        """Test AFSResponseResultsDetailsPeriod"""

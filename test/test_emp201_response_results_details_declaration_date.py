...
class TestEMP201ResponseResultsDetailsDeclarationDate(unittest.TestCase):
    """EMP201ResponseResultsDetailsDeclarationDate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EMP201ResponseResultsDetailsDeclarationDate:
        """Test EMP201ResponseResultsDetailsDeclarationDate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EMP201ResponseResultsDetailsDeclarationDate`
        """
        model = EMP201ResponseResultsDetailsDeclarationDate()
        if include_optional:
            return EMP201ResponseResultsDetailsDeclarationDate(
                exists = False,
                value = '2024-01-01'
            )
        else:
    ...
    def testEMP201ResponseResultsDetailsDeclarationDate(self):
        """Test EMP201ResponseResultsDetailsDeclarationDate"""

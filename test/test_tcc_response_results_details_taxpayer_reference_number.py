...
class TestTCCResponseResultsDetailsTaxpayerReferenceNumber(unittest.TestCase):
    """TCCResponseResultsDetailsTaxpayerReferenceNumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TCCResponseResultsDetailsTaxpayerReferenceNumber:
        """Test TCCResponseResultsDetailsTaxpayerReferenceNumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TCCResponseResultsDetailsTaxpayerReferenceNumber`
        """
        model = TCCResponseResultsDetailsTaxpayerReferenceNumber()
        if include_optional:
            return TCCResponseResultsDetailsTaxpayerReferenceNumber(
                exists = True,
                value = '12345678'
            )
        else:
    ...
    def testTCCResponseResultsDetailsTaxpayerReferenceNumber(self):
        """Test TCCResponseResultsDetailsTaxpayerReferenceNumber"""

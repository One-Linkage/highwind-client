...
class TestSHResponseResults(unittest.TestCase):
    """SHResponseResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SHResponseResults:
        """Test SHResponseResults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SHResponseResults`
        """
        model = SHResponseResults()
        if include_optional:
            return SHResponseResults(
                is_shareholders_certificate = True,
                pages_processed = 10,
                details = highwind_client.models.sh_response_results_details.SHResponse_results_details(
                    ...
                    company_shareholder_names = highwind_client.models.sh_response_results_details_company_shareholder_names.SHResponse_results_details_company_shareholder_names(
                        exists = True, 
                        value = 'Bob Bobbington, Moira Brown', ), 
                    company_shareholder_id_numbers = highwind_client.models.sh_response_results_details_company_shareholder_id_numbers.SHResponse_results_details_company_shareholder_id_numbers(
                        exists = True, 
                        value = '9202204720082, 9202201110082', ), 
                    shareholder_number_of_shares = highwind_client.models.sh_response_results_details_shareholder_number_of_shares.SHResponse_results_details_shareholder_number_of_shares(
                        exists = True, 
                        value = 'Bob Bobbington 2, Moira Brown 4', ), 
                    certificate_number = highwind_client.models.bcl_response_results_details_date_issued.BCLResponse_results_details_date_issued(
                        exists = True, 
                        value = '2024-01-01', ), 
                    certificate_issue_date = highwind_client.models.rl_response_results_details_services_product_rendered_date.RLResponse_results_details_services_product_rendered_date(
                        exists = True, 
                    ...
                    authorised_signature = highwind_client.models.sh_response_results_details_authorised_signature.SHResponse_results_details_authorised_signature(
                        exists = False, ), ),
    ...
    def testSHResponseResults(self):
        """Test SHResponseResults"""

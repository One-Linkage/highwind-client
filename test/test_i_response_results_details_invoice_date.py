...
class TestIResponseResultsDetailsInvoiceDate(unittest.TestCase):
    """IResponseResultsDetailsInvoiceDate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IResponseResultsDetailsInvoiceDate:
        """Test IResponseResultsDetailsInvoiceDate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IResponseResultsDetailsInvoiceDate`
        """
        model = IResponseResultsDetailsInvoiceDate()
        if include_optional:
            return IResponseResultsDetailsInvoiceDate(
                exists = True,
                value = '2024-06-10'
            )
        else:
    ...
    def testIResponseResultsDetailsInvoiceDate(self):
        """Test IResponseResultsDetailsInvoiceDate"""

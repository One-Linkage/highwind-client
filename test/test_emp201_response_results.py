...
class TestEMP201ResponseResults(unittest.TestCase):
    """EMP201ResponseResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EMP201ResponseResults:
        """Test EMP201ResponseResults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EMP201ResponseResults`
        """
        model = EMP201ResponseResults()
        if include_optional:
            return EMP201ResponseResults(
                is_emp201 = True,
                pages_processed = 10,
    ...
    def testEMP201ResponseResults(self):
        """Test EMP201ResponseResults"""

...
class TestModel3MMARResponseResultsDetailsReportDate(unittest.TestCase):
    """Model3MMARResponseResultsDetailsReportDate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Model3MMARResponseResultsDetailsReportDate:
        """Test Model3MMARResponseResultsDetailsReportDate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Model3MMARResponseResultsDetailsReportDate`
        """
        model = Model3MMARResponseResultsDetailsReportDate()
        if include_optional:
            return Model3MMARResponseResultsDetailsReportDate(
                exists = True,
                value = '2024-02-10'
            )
        else:
    ...
    def testModel3MMARResponseResultsDetailsReportDate(self):
        """Test Model3MMARResponseResultsDetailsReportDate"""

...
class TestSHResponse(unittest.TestCase):
    """SHResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SHResponse:
        """Test SHResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SHResponse`
        """
        model = SHResponse()
        if include_optional:
            return SHResponse(
                status = 'complete',
                results = highwind_client.models.sh_response_results.SHResponse_results(

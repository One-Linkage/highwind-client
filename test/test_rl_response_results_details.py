...
class TestRLResponseResultsDetails(unittest.TestCase):
    """RLResponseResultsDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RLResponseResultsDetails:
        """Test RLResponseResultsDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RLResponseResultsDetails`
        """
        model = RLResponseResultsDetails()
        if include_optional:
            return RLResponseResultsDetails(
    ...
    def testRLResponseResultsDetails(self):
        """Test RLResponseResultsDetails"""

...
class TestBEEAResponse(unittest.TestCase):
    """BEEAResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BEEAResponse:
        """Test BEEAResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BEEAResponse`
        """
        model = BEEAResponse()
        if include_optional:
            return BEEAResponse(
                status = 'complete',
                results = highwind_client.models.beea_response_results.BEEAResponse_results(

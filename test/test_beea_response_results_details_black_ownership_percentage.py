...
class TestBEEAResponseResultsDetailsBlackOwnershipPercentage(unittest.TestCase):
    """BEEAResponseResultsDetailsBlackOwnershipPercentage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BEEAResponseResultsDetailsBlackOwnershipPercentage:
        """Test BEEAResponseResultsDetailsBlackOwnershipPercentage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BEEAResponseResultsDetailsBlackOwnershipPercentage`
        """
        model = BEEAResponseResultsDetailsBlackOwnershipPercentage()
        if include_optional:
            return BEEAResponseResultsDetailsBlackOwnershipPercentage(
                exists = True,
                value = '100%'
            )
        else:
    ...
    def testBEEAResponseResultsDetailsBlackOwnershipPercentage(self):
        """Test BEEAResponseResultsDetailsBlackOwnershipPercentage"""

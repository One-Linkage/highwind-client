...
class TestEMP201ResponseResultsDetailsSdlReferenceNumberOptional(unittest.TestCase):
    """EMP201ResponseResultsDetailsSdlReferenceNumberOptional unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EMP201ResponseResultsDetailsSdlReferenceNumberOptional:
        """Test EMP201ResponseResultsDetailsSdlReferenceNumberOptional
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EMP201ResponseResultsDetailsSdlReferenceNumberOptional`
        """
        model = EMP201ResponseResultsDetailsSdlReferenceNumberOptional()
        if include_optional:
            return EMP201ResponseResultsDetailsSdlReferenceNumberOptional(
                exists = True,
                value = 'NA'
            )
        else:
    ...
    def testEMP201ResponseResultsDetailsSdlReferenceNumberOptional(self):
        """Test EMP201ResponseResultsDetailsSdlReferenceNumberOptional"""

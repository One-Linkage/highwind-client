...
class TestTCCResponseResultsDetails(unittest.TestCase):
    """TCCResponseResultsDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TCCResponseResultsDetails:
        """Test TCCResponseResultsDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TCCResponseResultsDetails`
        """
        model = TCCResponseResultsDetails()
        if include_optional:
            return TCCResponseResultsDetails(
    ...
    def testTCCResponseResultsDetails(self):
        """Test TCCResponseResultsDetails"""

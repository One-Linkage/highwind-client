...
class TestLGSResponse(unittest.TestCase):
    """LGSResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LGSResponse:
        """Test LGSResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LGSResponse`
        """
        model = LGSResponse()
        if include_optional:
            return LGSResponse(
                status = 'complete',
                results = highwind_client.models.lgs_response_results.LGSResponse_results(

...
class TestCOPResponse(unittest.TestCase):
    """COPResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> COPResponse:
        """Test COPResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `COPResponse`
        """
        model = COPResponse()
        if include_optional:
            return COPResponse(
                status = 'complete',
                results = highwind_client.models.cop_response_results.COPResponse_results(

...
class TestPOAResponseResultsDetailsAddressCountry(unittest.TestCase):
    """POAResponseResultsDetailsAddressCountry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> POAResponseResultsDetailsAddressCountry:
        """Test POAResponseResultsDetailsAddressCountry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `POAResponseResultsDetailsAddressCountry`
        """
        model = POAResponseResultsDetailsAddressCountry()
        if include_optional:
            return POAResponseResultsDetailsAddressCountry(
                exists = True,
                value = 'South Africa'
            )
        else:
    ...
    def testPOAResponseResultsDetailsAddressCountry(self):
        """Test POAResponseResultsDetailsAddressCountry"""

...
class TestModel3MBSResponseResultsDetailsBankName(unittest.TestCase):
    """Model3MBSResponseResultsDetailsBankName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Model3MBSResponseResultsDetailsBankName:
        """Test Model3MBSResponseResultsDetailsBankName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Model3MBSResponseResultsDetailsBankName`
        """
        model = Model3MBSResponseResultsDetailsBankName()
        if include_optional:
            return Model3MBSResponseResultsDetailsBankName(
                exists = True,
                value = 'Vault 76 Bank'
            )
        else:
    ...
    def testModel3MBSResponseResultsDetailsBankName(self):
        """Test Model3MBSResponseResultsDetailsBankName"""

...
class TestBEECResponseResults(unittest.TestCase):
    """BEECResponseResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BEECResponseResults:
        """Test BEECResponseResults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BEECResponseResults`
        """
        model = BEECResponseResults()
        if include_optional:
            return BEECResponseResults(
                is_bee_certificate = True,
                pages_processed = 10,
                details = highwind_client.models.beec_response_results_details.BEECResponse_results_details(
                    ...
                    black_designated_group_owned_percentage_breakdown_unemployed = , 
                    black_designated_group_owned_percentage_breakdown_rural = , 
                    black_designated_group_owned_percentage_breakdown_veterans = , ),
    ...
    def testBEECResponseResults(self):
        """Test BEECResponseResults"""

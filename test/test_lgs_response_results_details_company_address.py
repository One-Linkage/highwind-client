...
class TestLGSResponseResultsDetailsCompanyAddress(unittest.TestCase):
    """LGSResponseResultsDetailsCompanyAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LGSResponseResultsDetailsCompanyAddress:
        """Test LGSResponseResultsDetailsCompanyAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LGSResponseResultsDetailsCompanyAddress`
        """
        model = LGSResponseResultsDetailsCompanyAddress()
        if include_optional:
            return LGSResponseResultsDetailsCompanyAddress(
                exists = True,
    ...
    def testLGSResponseResultsDetailsCompanyAddress(self):
        """Test LGSResponseResultsDetailsCompanyAddress"""

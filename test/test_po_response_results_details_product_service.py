...
class TestPOResponseResultsDetailsProductService(unittest.TestCase):
    """POResponseResultsDetailsProductService unit test stubs"""
    ...
    def make_instance(self, include_optional) -> POResponseResultsDetailsProductService:
        """Test POResponseResultsDetailsProductService
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `POResponseResultsDetailsProductService`
        """
        model = POResponseResultsDetailsProductService()
        if include_optional:
            return POResponseResultsDetailsProductService(
                exists = True,
    ...
    def testPOResponseResultsDetailsProductService(self):
        """Test POResponseResultsDetailsProductService"""

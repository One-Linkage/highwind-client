...
class TestPOResponse(unittest.TestCase):
    """POResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> POResponse:
        """Test POResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `POResponse`
        """
        model = POResponse()
        if include_optional:
            return POResponse(

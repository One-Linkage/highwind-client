...
class TestBEECResponse(unittest.TestCase):
    """BEECResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BEECResponse:
        """Test BEECResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BEECResponse`
        """
        model = BEECResponse()
        if include_optional:
            return BEECResponse(
                status = 'complete',
                results = highwind_client.models.beec_response_results.BEECResponse_results(

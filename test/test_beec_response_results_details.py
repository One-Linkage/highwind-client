...
class TestBEECResponseResultsDetails(unittest.TestCase):
    """BEECResponseResultsDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BEECResponseResultsDetails:
        """Test BEECResponseResultsDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BEECResponseResultsDetails`
        """
        model = BEECResponseResultsDetails()
        if include_optional:
            return BEECResponseResultsDetails(
                ...
                enterprise_registration_number = highwind_client.models.beec_response_results_details_enterprise_registration_number.BEECResponse_results_details_enterprise_registration_number(
                    exists = True, 
                    value = '123ABC', ),
                certificate_number = highwind_client.models.beec_response_results_details_enterprise_registration_number.BEECResponse_results_details_enterprise_registration_number(
                    exists = True, 
                    value = '123ABC', ),
                certificate_issuer_name = highwind_client.models.beec_response_results_details_enterprise_registration_number.BEECResponse_results_details_enterprise_registration_number(
                    exists = True, 
                    value = '123ABC', ),
                certificate_issue_date = highwind_client.models.bcl_response_results_details_date_issued.BCLResponse_results_details_date_issued(
                    exists = True, 
                    value = '2024-01-01', ),
                certificate_expiry_date = highwind_client.models.bcl_response_results_details_date_issued.BCLResponse_results_details_date_issued(
                    exists = True, 
                    value = '2024-01-01', ),
                ...
                total_number_of_shareholders = highwind_client.models.beec_response_results_details_total_number_of_shareholders.BEECResponse_results_details_total_number_of_shareholders(
                    exists = True, 
                    value = '1', ),
                number_of_black_shareholders = highwind_client.models.beec_response_results_details_total_number_of_shareholders.BEECResponse_results_details_total_number_of_shareholders(
                    exists = True, 
                    value = '1', ),
                number_of_white_shareholders = highwind_client.models.beec_response_results_details_total_number_of_shareholders.BEECResponse_results_details_total_number_of_shareholders(
                    exists = True, 
                    value = '1', ),
                ...
                black_ownership_female_percentage = highwind_client.models.beea_response_results_details_black_ownership_percentage.BEEAResponse_results_details_black_ownership_percentage(
                    exists = True, 
                    value = '100%', ),
                white_ownership_percentage = highwind_client.models.beea_response_results_details_black_ownership_percentage.BEEAResponse_results_details_black_ownership_percentage(
                    exists = True, 
                    value = '100%', ),
    ...
    def testBEECResponseResultsDetails(self):
        """Test BEECResponseResultsDetails"""

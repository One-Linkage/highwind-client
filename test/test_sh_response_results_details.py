...
class TestSHResponseResultsDetails(unittest.TestCase):
    """SHResponseResultsDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SHResponseResultsDetails:
        """Test SHResponseResultsDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SHResponseResultsDetails`
        """
        model = SHResponseResultsDetails()
        if include_optional:
            return SHResponseResultsDetails(
    ...
    def testSHResponseResultsDetails(self):
        """Test SHResponseResultsDetails"""

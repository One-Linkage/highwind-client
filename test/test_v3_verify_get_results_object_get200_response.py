...
class TestV3VerifyGetResultsObjectGet200Response(unittest.TestCase):
    """V3VerifyGetResultsObjectGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V3VerifyGetResultsObjectGet200Response:
        """Test V3VerifyGetResultsObjectGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V3VerifyGetResultsObjectGet200Response`
        """
        model = V3VerifyGetResultsObjectGet200Response()
        if include_optional:
            return V3VerifyGetResultsObjectGet200Response(
                status = 'complete',
                results = highwind_client.models.po_response_results.POResponse_results(
                    is_purchase_order = True, 
                    pages_processed = 10, 
                    details = highwind_client.models.po_response_results_details.POResponse_results_details(
                        ...
                        purchase_order_number = highwind_client.models.po_response_results_details_purchase_order_number.POResponse_results_details_purchase_order_number(
                            exists = True, 
                            value = 'PO1234ABC', ), 
                        purchase_order_date = highwind_client.models.po_response_results_details_purchase_order_date.POResponse_results_details_purchase_order_date(
                            exists = True, 
                            value = '2024/02/24', ), 
                        ...
                        total_amount = highwind_client.models.po_response_results_details_total_amount.POResponse_results_details_total_amount(
                            exists = True, 
                            value = '$ 4000.00', ), ), 
    ...
    def testV3VerifyGetResultsObjectGet200Response(self):
        """Test V3VerifyGetResultsObjectGet200Response"""
